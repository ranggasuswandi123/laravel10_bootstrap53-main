...
use App\Http\Controllers\NilaiRanggaController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('nilai', [NilaiRanggaController::class, 'index'])->name('nilai.index');
    Route::get('cetak_nilai', [NilaiRanggaController::class, 'cetak_nilai'])->name('cetak_nilai');
